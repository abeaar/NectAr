...
enum StoryCatalog {
    static let all: [Story] = [
        ...
        Story(id: "streaming", title: "Streaming YouTube", icon: "StoryCard-2", description: "Watching videos online feels easy, even when they come from faraway places. That instant magic is powered by streaming! \n\nExplore how millions of data frames zoom straight to your screen in real time."),
        Story(id: "iot", title: "Internet of Things", icon: "StoryCard-1", description: "Your living room light turns on the moment you walk through the front door, no switches touched. Explore the Internet of Things (IoT)! \n\nDiscover the hidden wireless network connecting the gadgets around you"),
